...
from the game for %s?`,
		...
		TextIDAdvancedSettings: "Game Config",
		TextIDBack:             "Back",
		TextIDClose:            "Close",
...
para quitar los anuncios del juego?`,
		...
		TextIDAdvancedSettings: "Config del juego",
		TextIDBack:             "Cerrar",
		TextIDClose:            "Cerrar",
...
来移除游戏里的广告吗?`,
		...
		TextIDAdvancedSettings: "游戏配置",
		TextIDBack:             "返回",
		TextIDClose:            "关闭",
		TextIDItemCheck:        "查看",
		TextIDMenu:             "主选单",
		TextIDBGMVolume:        "背景音乐音量",
		TextIDSEVolume:         "音效音量",
		TextIDVibration:        "振动",
...
來移除遊戲裡的廣告嗎?`,
		...
		TextIDAdvancedSettings: "遊戲配置",
		TextIDBack:             "返回",
		TextIDClose:            "關閉",
		TextIDItemCheck:        "查看",
		TextIDMenu:             "主選單",
		TextIDBGMVolume:        "背景音樂音量",
		TextIDSEVolume:         "音效音量",
		TextIDVibration:        "振動",
...
광고를 제거하시겠습니까?`,
		...
		TextIDAdvancedSettings: "게임 구성",
		TextIDBack:             "뒤로",
		TextIDClose:            "닫기",
		TextIDItemCheck:        "체크",
		TextIDMenu:             "타이틀",
		TextIDBGMVolume:        "배경 음악 볼륨",
		TextIDSEVolume:         "사운드 볼륨",
		TextIDVibration:        "진동",
